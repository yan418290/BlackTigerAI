  ...
  <div class="container home-container">
    ...
    <div class="hero-section">
      <div class="hero-content">
        ...
        <h1 class="page-title" style="color: #ff3642;">黑虎AI，灵感一触即发</h1>
        <p class="page-subtitle">输入你的创意主题，让 AI 帮你生成<span style="color: #ff3642;">爆款标题、正文和封面图</span></p>
      </div>
      ...
      <ComposerInput
        ...
        @pageCountChange="(count) => pageCount = count"
      />
    </div>
    ...
    <div class="page-footer">
      <div class="footer-tip">
        更多自媒体AI工具，访问 <a href="https://BlackTigerAI.com" target="_blank" rel="noopener noreferrer">BlackTigerAI.com</a> 官方站点
      </div>
      <div class="footer-copyright">
        © 2025 <a href="https://BlackTigerAI.com" target="_blank" rel="noopener noreferrer">BlackTigerAI</a> By 黑虎AI (BlackTigerAI)
      </div>
 ...
 * 生成大纲
 */
async function handleGenerate(selectedPageCount: number) {
  ...
  try {
    ...
    const targetPageCount = selectedPageCount || pageCount.value
